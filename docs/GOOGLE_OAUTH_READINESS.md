...
- [x] Gemini Paid/Free/unknown policy is conditional, credential-bound, expiring, and fail-closed
- [x] Separate cloud connected-data consent implemented and revocable
- [x] Connected-service state remains distinct from model-policy eligibility
...
- [ ] Live Gmail/Drive-to-Gemini test completed with a confirmed Paid Gemini project and synthetic data
